...
lhc.y2026.add_cycle(
    name="pp",
    label="Proton Physics 2026",
    particles=["proton","proton"],
    charges=[1,1]
)
lhc.y2026.pp.refresh()
lhc.y2026.pp.add_process("ramp","RAMP-SQUEEZE-ROTATE-6.8TeV-ATS-1.2m-2026_V1")
lhc.y2026.pp.add_process("qchange","QCHANGE-6.8TeV-2026_V1")
lhc.y2026.pp.add_process("physics","PHYSICS-6.8TeV-1.2m-2026_V1")
lhc.y2026.pp.add_process("levelling","SQUEEZE-6.8TeV-1.2m-15cm-2026_V1")
...
lhc.y2026.pp.levelling.label="Squeeze to 15 cm"
lhc.y2026.pp.save_data(level=1)

# 2026 - Ions
lsa.findBeamProcesses(".*ion.*2026.*")
